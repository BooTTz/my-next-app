...
export const MOCK_PLANS: InspectionPlan[] = [
  { id: "p1", teamId: "t1", planNo: "JHBX-2025-001", name: "2025年度工贸企业日常安全检查计划（第一季度）", type: "routine", year: 2025, startDate: "2025-01-15", endDate: "2025-03-31", description: "针对辖区内工贸企业开展日常安全生产检查", scope: "博兴县全部在产工贸企业", basis: "《安全生产法》《工贸行业安全生产监管办法》", creatorId: "u1", creatorName: "李伟", status: "in_progress", createdAt: "2025-01-12", updatedAt: "2025-01-15", taskCount: 5, completedTaskCount: 2 },
  { id: "p2", teamId: "t1", planNo: "JHBX-2025-002", name: "2025年春节前安全生产专项检查", type: "holiday", year: 2025, startDate: "2025-01-20", endDate: "2025-02-05", description: "春节前安全生产专项检查，重点检查消防安全、用电安全等", scope: "全县重点工贸企业", basis: "关于做好2025年春节期间安全生产工作的通知", creatorId: "u1", creatorName: "李伟", status: "completed", createdAt: "2025-01-10", updatedAt: "2025-02-06", taskCount: 3, completedTaskCount: 3 },
  { id: "p3", teamId: "t1", planNo: "JHBX-2025-003", name: "有限空间作业安全专项检查", type: "special", year: 2025, startDate: "2025-03-01", endDate: "2025-04-30", description: "重点检查涉及有限空间作业的企业安全管理情况", scope: "涉及有限空间作业的工贸企业", basis: "《工贸企业有限空间作业安全管理与监督暂行规定》", creatorId: "u1", creatorName: "李伟", status: "published", createdAt: "2025-02-20", updatedAt: "2025-02-25", taskCount: 4, completedTaskCount: 0 },
  { id: "p4", teamId: "t1", planNo: "JHBX-2025-004", name: "2025年度工贸企业双随机检查计划", type: "random", year: 2025, startDate: "2025-04-01", endDate: "2025-06-30", description: "按照双随机一公开要求开展安全检查", scope: "随机抽取被检查企业和检查人员", creatorId: "u1", creatorName: "李伟", status: "draft", createdAt: "2025-03-15", updatedAt: "2025-03-15", taskCount: 0, completedTaskCount: 0 },
  { id: "p5", teamId: "t1", planNo: "JHBX-2025-005", name: "2025年第二季度日常安全检查计划", type: "routine", year: 2025, startDate: "2025-04-01", endDate: "2025-06-30", description: "第二季度工贸企业常规安全检查", creatorId: "u1", creatorName: "李伟", status: "draft", createdAt: "2025-03-20", updatedAt: "2025-03-20", taskCount: 0, completedTaskCount: 0 },
];
...
export const MOCK_TASKS: InspectionTask[] = [
  ...
  { id: "tk7", teamId: "t1", planId: "p3", planName: "有限空间作业安全专项检查", taskNo: "RW-2025-007", enterpriseId: "e1", enterpriseName: "博兴县鑫盛金属制品有限公司", inspectorIds: ["u2","u3"], inspectorNames: ["张敏","王强"], leadInspectorId: "u2", leadInspectorName: "张敏", scheduledDate: "2025-03-10", status: "accepted", createdAt: "2025-02-25", updatedAt: "2025-03-02", hazardCount: 0, rectifiedCount: 0 },
...
export const MOCK_HAZARDS: Hazard[] = [
  ...
  { id: "h4", teamId: "t1", taskId: "tk3", enterpriseId: "e3", enterpriseName: "博兴县天成机械加工厂", hazardNo: "YH-2025-004", level: "general", category: "onsite", subCategory: "o04", subCategoryName: "安全标识", description: "危险作业区域缺少安全警示标识，设备操作区域未设置安全标线", location: "机加工车间整体", photos: ["/mock/hazard4.jpg"], suggestion: "在所有危险区域设置明显的安全警示标识和安全标线", deadline: "2025-03-25", responsiblePerson: "李安全", status: "submitted", discoveredAt: "2025-03-05", discoveredBy: "u6", discoveredByName: "孙浩", createdAt: "2025-03-05" },
  { id: "h5", teamId: "t1", taskId: "tk3", enterpriseId: "e3", enterpriseName: "博兴县天成机械加工厂", hazardNo: "YH-2025-005", level: "general", category: "management", subCategory: "m03", subCategoryName: "安全责任制", description: "企业全员安全生产责任制文件未更新，部分岗位安全职责不明确", location: "行政管理-安全管理制度", photos: ["/mock/hazard5.jpg"], suggestion: "修订全员安全生产责任制，明确各岗位安全职责并组织学习签字", deadline: "2025-03-30", responsiblePerson: "李安全", status: "closed", discoveredAt: "2025-03-05", discoveredBy: "u3", discoveredByName: "王强", createdAt: "2025-03-05" },
  { id: "h6", teamId: "t1", taskId: "tk3", enterpriseId: "e3", enterpriseName: "博兴县天成机械加工厂", hazardNo: "YH-2025-006", level: "general", category: "onsite", subCategory: "o06", subCategoryName: "消防安全", description: "消防通道堆放杂物，灭火器2具已过期未更换", location: "成品仓库", photos: ["/mock/hazard6.jpg"], suggestion: "清理消防通道，更换过期灭火器，确保消防通道畅通", deadline: "2025-03-15", responsiblePerson: "李安全", status: "closed", discoveredAt: "2025-03-05", discoveredBy: "u6", discoveredByName: "孙浩", createdAt: "2025-03-05" },
  { id: "h7", teamId: "t1", taskId: "tk4", enterpriseId: "e4", enterpriseName: "博兴县宏达纺织有限公司", hazardNo: "YH-2025-007", level: "general", category: "onsite", subCategory: "o10", subCategoryName: "粉尘防爆", description: "纺织车间粉尘收集装置维护不及时，集尘管道有积尘现象", location: "纺织一车间", photos: ["/mock/hazard7.jpg"], suggestion: "定期清理集尘管道，建立粉尘收集装置维护保养制度", deadline: "2025-04-05", responsiblePerson: "张安", status: "notified", discoveredAt: "2025-03-15", discoveredBy: "u2", discoveredByName: "张敏", createdAt: "2025-03-15" },
